...
from music_transcription.basic_pitch.utils.note_creation import model_output_to_notes
from music_transcription.basic_pitch.utils.audio_to_frame import get_audio_input, unwrap_output
from music_transcription.basic_pitch.utils.write_data import write_midi_file
from music_transcription.basic_pitch.utils.color_text import toYellow
import argparse

from music_transcription.basic_pitch.constants import FFT_HOP, AUDIO_SAMPLE_RATE, AUDIO_N_SAMPLES, n_overlapping_frames
import os

os.environ['TF_CPP_MIN_LOG_LEVEL'] = '1' # ignore the message

def music_transcription(input_audio, model_onnx, save_dictionary):
